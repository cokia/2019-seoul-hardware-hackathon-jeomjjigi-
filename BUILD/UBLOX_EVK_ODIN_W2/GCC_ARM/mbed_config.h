...
#define BLE_STACK_UBX                                                         0                                                                                                // set by target:MODULE_UBLOX_ODIN_W2
...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "12345678a"                                                                                      // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "GCAMP"                                                                                          // set by application
...
#define MBED_CONF_LWIP_PBUF_POOL_SIZE                                         10                                                                                               // set by library:lwip[UBLOX_EVK_ODIN_W2]
...
#define MBED_CONF_MBED_TRACE_ENABLE                                           16                                                                                               // set by application[*]
...
#define MBED_CONF_PLATFORM_CRASH_CAPTURE_ENABLED                              1                                                                                                // set by library:platform[UBLOX_EVK_ODIN_W2]
...
#define MBED_CONF_PLATFORM_FATAL_ERROR_AUTO_REBOOT_ENABLED                    1                                                                                                // set by library:platform[UBLOX_EVK_ODIN_W2]
...
#define MBED_CONF_SD_SPI_CLK                                                  D13                                                                                              // set by library:sd[UBLOX_EVK_ODIN_W2]
#define MBED_CONF_SD_SPI_CS                                                   D9                                                                                               // set by library:sd[UBLOX_EVK_ODIN_W2]
#define MBED_CONF_SD_SPI_MISO                                                 D12                                                                                              // set by library:sd[UBLOX_EVK_ODIN_W2]
#define MBED_CONF_SD_SPI_MOSI                                                 D11                                                                                              // set by library:sd[UBLOX_EVK_ODIN_W2]
...
#define MBED_CONF_STORAGE_STORAGE_TYPE                                        TDB_INTERNAL                                                                                     // set by library:storage[UBLOX_EVK_ODIN_W2]
